      ...
      <section className="bg-gradient-to-br from-primary/10 via-accent to-background py-8 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            Descubra <span className="text-primary">achados únicos</span> perto de você
          </h1>
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-6">
            ...
            <div className="h-[500px] lg:h-[calc(100vh-280px)] rounded-lg overflow-hidden shadow-lg">
              <BusinessMap
                ...
                userLocation={!geoLoading && !geoError ? { lat: latitude, lng: longitude } : null}
              />
            </div>
            ...
            <div className="space-y-4 max-h-[calc(100vh-280px)] overflow-y-auto">
              <div className="flex items-center justify-between">
                <h2 className="font-semibold">
                  {physicalBusinesses.length} estabelecimento{physicalBusinesses.length !== 1 ? 's' : ''} encontrado{physicalBusinesses.length !== 1 ? 's' : ''}
                </h2>
              </div>

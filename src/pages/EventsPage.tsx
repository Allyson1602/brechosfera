      ...
      <section className="bg-gradient-to-br from-primary/10 via-accent to-background py-8 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Fique por dentro dos melhores eventos, bazares especiais e promoções imperdíveis!
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-6">
        {filteredEvents.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-xl font-semibold mb-2">Nenhum evento {activeTab === 'ongoing' ? 'acontecendo' : activeTab === 'upcoming' ? 'programado' : 'passado'}</h2>
          ...
          {selectedEvent && (
            <div>
              ...
              <div className="p-6">
                <SheetHeader className="text-left mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Badge className={
                      ...
                      {selectedEvent.status === 'ongoing' ? 'Acontecendo Agora' : selectedEvent.status === 'upcoming' ? 'Em Breve' : 'Encerrado'}
                    </Badge>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {format(selectedEvent.startDate, 'yyyy-MM-dd') !== format(selectedEvent.endDate, 'yyyy-MM-dd') && (
                        <p className="text-sm text-muted-foreground">
                          até {format(new Date(selectedEvent.endDate), "d 'de' MMMM 'de' yyyy", { locale: ptBR })}
                        </p>
                      )}
                    </div>
                  </div>
                ...
                {selectedEvent.isOnline && selectedEvent.onlineUrl && selectedEvent.status !== 'past' && (
                  <Button className="w-full mt-6" onClick={() => window.open(selectedEvent.onlineUrl, '_blank')}>

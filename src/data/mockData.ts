...
export const mockBusinesses: Business[] = [
  {
    ...
    description: 'Roupas femininas selecionadas com muito carinho. Peças únicas e exclusivas de marcas renomadas com preços acessíveis.',
    category: 'brecho',
    isOnline: false,
    rating: 4.8,
    reviewCount: 127,
  ...
  },
  {
    ...
    description: 'Bazar beneficente com renda revertida para instituições de caridade. Encontre roupas, móveis, livros e muito mais!',
    category: 'bazar',
    isOnline: false,
    rating: 4.9,
    reviewCount: 89,
    ...
    itemTypes: ['Roupas Femininas', 'Roupas Masculinas', 'Roupas Infantis', 'Móveis', 'Livros', 'Decoração'],
  ...
  },
  {
    ...
    description: 'Brechó especializado em peças vintage e retrô. Encontre tesouros únicos dos anos 60, 70 e 80!',
    category: 'brecho',
    isOnline: false,
    rating: 4.7,
    reviewCount: 65,
  ...
  },
  {
    ...
    description: 'Brechó online com curadoria especial. Enviamos para todo o Brasil! Peças de qualidade a preços incríveis.',
    category: 'brecho',
    isOnline: true,
    rating: 4.6,
    reviewCount: 234,
    coverImage: 'https://images.unsplash.com/photo-1551232864-3f0890e580d9?w=800',
    images: [
      'https://images.unsplash.com/photo-1551232864-3f0890e580d9?w=800',
      'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=800',
    ],
  ...
  },
  {
    ...
    description: 'Bazar online com variedade incrível! Roupas, decoração, eletrônicos e muito mais. Tudo com preço de bazar!',
    category: 'bazar',
    isOnline: true,
    rating: 4.4,
    reviewCount: 156,
    ...
    operatingHours: [],
    itemTypes: ['Roupas Femininas', 'Decoração', 'Eletrônicos', 'Artigos para Casa'],
...
export const mockEvents: Event[] = [
  {
    ...
    description: 'O maior bazar de inverno da cidade! Casacos, blusas, cachecóis e muito mais com até 70% de desconto.',
    businessId: '2',
    business: {
      id: '2',
      name: 'Bazar Solidário Esperança',
  ...
  },
  {
    ...
    description: 'Live especial com peças vintage raras! Entre ao vivo e garanta as melhores peças.',
    businessId: '3',
    business: {
      id: '3',
      name: 'Garagem Fashion',
  ...
  },
  {
    ...
    description: 'Bazar especial de natal com renda revertida para famílias carentes. Venha fazer parte dessa corrente do bem!',
    businessId: '2',
    business: {
      id: '2',
      name: 'Bazar Solidário Esperança',
    ...
    coverImage: 'https://images.unsplash.com/photo-1512909006721-3d6018887383?w=800',
